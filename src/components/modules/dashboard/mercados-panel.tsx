...
export function MercadosPanel({ btcPrice, marketData }: MercadosPanelProps) {
  ...
  const watchlist = [
    ...
    },
    {
      ...
      price: fmtEur(md?.iglnPrice ?? null, 2),
      chg: fmtChange(md?.iglnChangePct ?? null),
      chgColor: changeColor(md?.iglnChangePct ?? null),
    },
    {
      sym: 'CSPX',
      name: 'S&P 500 ETF',
      color: 'var(--module-patrimonio)',
      price: fmtEur(md?.cspxPrice ?? null, 2),
      chg: fmtChange(md?.cspxChangePct ?? null),
      chgColor: changeColor(md?.cspxChangePct ?? null),
    },
    {
      sym: 'DXY',
      name: 'US Dollar',
