      ...
      >
        ...
        {onSuggestTags && (
          <button
            ...
            className="flex h-5 w-5 items-center justify-center rounded text-text-tertiary hover:text-[var(--module-notas)] transition-colors disabled:opacity-40 flex-shrink-0"
          >
            {suggestLoading ? (
              <span className="h-3 w-3 rounded-full border border-[var(--module-notas)] border-t-transparent animate-spin" />
            ) : (
