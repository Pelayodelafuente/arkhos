...
export interface SubscriptionService {
  ...
  color: string
  /** True when the SVG has white/light fills and needs a dark background to be visible */
  darkIcon?: boolean
}
...
export const subscriptionServices: SubscriptionService[] = [
  ...
  { id: "apple", name: "Apple", icon: AppleDark, color: "#000000", darkIcon: true },
  ...
  { id: "github", name: "GitHub", icon: GitHubDark, color: "#181717", darkIcon: true },
  { id: "figma", name: "Figma", icon: Figma, color: "#F24E1E" },
  { id: "notion", name: "Notion", icon: Notion, color: "#000000", darkIcon: true },
  { id: "openai", name: "ChatGPT", icon: OpenAIDark, color: "#10A37F", darkIcon: true },
  { id: "vercel", name: "Vercel", icon: VercelDark, color: "#000000", darkIcon: true },
  ...
  { id: "1password", name: "1Password", icon: OnePasswordDark, color: "#0572EC", darkIcon: true },
  { id: "raycast", name: "Raycast", icon: Raycast, color: "#FF6363" },
  { id: "railway", name: "Railway", icon: RailwayDark, color: "#0B0D0E", darkIcon: true },
]
